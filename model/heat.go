...
type Heat struct {
	...
	StartDelayEstimation time.Time          `json:"start_delay_estimation,omitempty" bson:"start_delay_estimation"` // manual calculation of delay				estimation from delay
	StartAt              time.Time          `json:"start_at,omitempty" bson:"start_at"`                             // automatically		actual moment when it started
	FinishedAt           time.Time          `json:"finished_at,omitempty" bson:"finished_at"`                       // automatically		actual moment when it finished
