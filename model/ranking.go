...
type Ranking struct {
	...
	LenexId    string             `json:"lenex_id,omitempty" bson:"lenex_id,omitempty"` // 1,2,3 (per event)
	DsvId      string             `json:"dsv_id,omitempty" bson:"dsv_id,omitempty"`     // 34234141 (global)
